...
public class EnterpriseService {
	 ...
	 * @return
	 */
	public Page<Enterprise> findSearch(Map<String,Object> whereMap, int page, int size) {
	 ...
	 * @return
	 */
	public List<Enterprise> findSearch(Map<String,Object> whereMap) {
		Specification<Enterprise> specification = createSpecification(whereMap);
	 ...
	 * @return
	 */
	private Specification<Enterprise> createSpecification(Map<String,Object> searchMap) {

		return new Specification<Enterprise>() {

			private static final long serialVersionUID = 2224314883091322363L;
