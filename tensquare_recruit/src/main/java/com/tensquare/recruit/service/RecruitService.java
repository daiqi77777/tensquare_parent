...
public class RecruitService {
	 ...
	 * @return
	 */
	public Page<Recruit> findSearch(Map<String,Object> whereMap, int page, int size) {
	 ...
	 * @return
	 */
	public List<Recruit> findSearch(Map<String,Object> whereMap) {
		Specification<Recruit> specification = createSpecification(whereMap);
	 ...
	 * @return
	 */
	private Specification<Recruit> createSpecification(Map<String,Object> searchMap) {

		return new Specification<Recruit>() {

			private static final long serialVersionUID = 9035153838232081698L;
