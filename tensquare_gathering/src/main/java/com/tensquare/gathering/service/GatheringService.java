...
public class GatheringService {
	 ...
	 * @return
	 */
	public Page<Gathering> findSearch(Map<String,Object> whereMap, int page, int size) {
	 ...
	 * @return
	 */
	public List<Gathering> findSearch(Map<String,Object> whereMap) {
		Specification<Gathering> specification = createSpecification(whereMap);
	 ...
	 * @return
	 */
	private Specification<Gathering> createSpecification(Map<String,Object> searchMap) {

		return new Specification<Gathering>() {

			private static final long serialVersionUID = -6124534614019639835L;
